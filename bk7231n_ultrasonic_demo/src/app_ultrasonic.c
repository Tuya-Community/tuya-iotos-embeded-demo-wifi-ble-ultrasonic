 ...
 * @LastEditTime: 2021-03-18 17:14:15
 */
...
OPERATE_RET app_ultrasonic_init(IN APP_MODE mode)
{
...
VOID app_report_all_dp_status(VOID)
{
    ...
    dp_arr[0].dpid = DPID_MEASURE_DISTANCE;
    dp_arr[0].type = PROP_VALUE;
    dp_arr[0].time_stamp = 0;
    dp_arr[0].value.dp_value = app_ctrl_data.measure_distance_mm;
